 ...
 */
final class Version20231017081422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_verified TINYINT(1) NOT NULL, ADD banned_until DATETIME DEFAULT NULL');
    }
